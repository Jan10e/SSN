...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 14 12:10:39 2018
...
u_0 = sp.array([1, 1]) #initiate at rate
T_init = 0
T_final = 100
dt = 1e-3
...
def df(u, t):
    du = (-u + Kk * ReLU(sp.dot(Ww, u) + h)**Nn)/tau
    return du
...
u_E, u_I = 1, 1 # these are the starting rate values
...
# h = 0 gives fixed point 
# h = 2 gives fixed points 
# h = 15 gives fixed point 
...
guess = sp.random.uniform(0, 50, 2) #rate values
