...
figure;
subplot(2,2,1)
imagesc(mean_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,1))
title("mean rate E")
xlabel("a-range")
ylabel("b-range")
colorbar
...
xticks = linspace(1, size(mean_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,1), 2), numel(xticklabels));
set(gca, 'XTick', xticks, 'XTickLabel', xticklabels)

yticklabels = b_range(mean_std_sm(1,2):mean_std_sm(end,2));
yticks = linspace(1, size(mean_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,1), 1), numel(yticklabels));
set(gca, 'YTick', yticks, 'YTickLabel', yticklabels)


subplot(2,2,2)
imagesc(mean_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,2))
title("mean rate I")
xlabel("a-range")
ylabel("b-range")
colorbar
...
xticklabels = a_range(1:2:11);
xticks = linspace(1, size(mean_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,2), 2), numel(xticklabels));
set(gca, 'XTick', xticks, 'XTickLabel', xticklabels)

yticklabels = b_range(mean_std_sm(1,2):mean_std_sm(end,2));
yticks = linspace(1, size(mean_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,2), 1), numel(yticklabels));
set(gca, 'YTick', yticks, 'YTickLabel', yticklabels)


subplot(2,2,3)
imagesc(stds_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,1))
title("std dev rate E")
xlabel("a-range")
ylabel("b-range")
colorbar
...
xticklabels = a_range(1:2:11);
xticks = linspace(1, size(stds_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,1), 2), numel(xticklabels));
set(gca, 'XTick', xticks, 'XTickLabel', xticklabels)

yticklabels = b_range(mean_std_sm(1,2):mean_std_sm(end,2));
yticks = linspace(1, size(stds_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,1), 1), numel(yticklabels));
set(gca, 'YTick', yticks, 'YTickLabel', yticklabels)


subplot(2,2,4)
imagesc(stds_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,2))
title("std dev rate I")
xlabel("a-range")
ylabel("b-range")
colorbar
...
xticklabels = a_range(1:2:11);
xticks = linspace(1, size(stds_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,2), 2), numel(xticklabels));
set(gca, 'XTick', xticks, 'XTickLabel', xticklabels)

yticklabels = b_range(mean_std_sm(1,2):mean_std_sm(end,2));
yticks = linspace(1, size(stds_par(mean_std_sm(1,2):mean_std_sm(end,2),1:11,2), 1), numel(yticklabels));
set(gca, 'YTick', yticks, 'YTickLabel', yticklabels)
